    ...
    <div class="container mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div class="flex items-center gap-6">
            ...
            <a href="{{ route('checkout', app()->getLocale()) }}"
                class="relative text-brand-charcoal hover:text-brand-sand transition-colors block p-2 group"
                aria-label="Cart">
                <div class="relative">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor"
                        class="w-[22px] h-[22px] group-hover:scale-110 transition-transform duration-300">

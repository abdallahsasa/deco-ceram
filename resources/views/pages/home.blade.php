...
@section('content')
    ...
    <section class="relative h-[90vh] overflow-hidden bg-brand-charcoal">
        <img src="/images/hero/luxury_interior.png" alt="Luxury Interior"
            class="w-full h-full object-cover opacity-80 animate-fade-in transition-transform duration-[10000ms] ease-out">

        <div class="absolute inset-0 flex items-center">
            <div class="container mx-auto px-6">
                <div class="max-w-2xl space-y-8 reveal reveal-up">
                    <h1 class="text-white text-6xl md:text-8xl font-serif leading-tight tracking-tight">
                        {{ __('messages.home.hero_title') }} <br>
                        <span class="italic text-brand-sand-light">{{ __('messages.home.hero_subtitle') }}</span>
                    </h1>
                    <p class="text-white/80 text-xl font-light tracking-wide max-w-lg leading-relaxed">
